...
//  });
 ...
 $(".sell").on('click',function(){
  ...
  var sort = $("#sortajax option:selected").text();
  // alert(sort);
  var url = $("#url").val();
  $.ajax({
    url:url,
 ...
 $(".transmissions").on('click',function(){
  var transmissions = get_filter(this);
 var sort = $("#sortajax option:selected").text();
 // alert(sort);
 var url = $("#url").val();
 $.ajax({
   url:url,
   method:"post",
   data:{transmissions:transmissions,sort:sort,url:url},
   success:function(data){
     $('.filter_products').html(data);
   }
 })
...
$(".door").on('click',function(){
 ...
 $.ajax({
   url:url,
   method:"post",
   data:{door:door,sort:sort,url:url},
   success:function(data){
     $('.filter_products').html(data);
   }
 })
...
$(".condition").on('click',function(){
 ...
 $.ajax({
   url:url,
   method:"post",
   data:{condition:condition,sort:sort,url:url},
   success:function(data){
     $('.filter_products').html(data);
   }
 })
