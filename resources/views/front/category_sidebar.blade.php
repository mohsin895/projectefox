...
<div id="sidebar" class="span33">
                ...
                <div class="price col-md-2">
                    <form action="?" method="get">
                        ...
                        <div class="form-group price-search text-center">
                            ...
                            <label for="">$</label>
                            <input type="text" class="form-control price" name="start_price" id="start_price">
                            <label for="">to $</label>
                            <input type="text" class="form-control price" name="end_price" id="end_price">
              ...
              <input type="checkbox" class="form-control transmissions" name="transmissions[]" id="{{$trans}}" value="{{$trans}}">&nbsp; &nbsp;{{$trans}}<br>
              @endforeach
</div>
                @endif
                <br>
              ...
              <input type="checkbox" class="form-control condition" name="condition[]" id="{{$con}}" value="{{$con}}">&nbsp; &nbsp;{{$con}}<br>
              @endforeach
</div>
                @endif
                <br>
