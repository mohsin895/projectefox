                        ...
                        <tr class="mt-5">
                            ...
                            <td>
                                <p>
                                    ...
                                    <input type="hidden" name="business_name" value="{{$row['title']}}" id="">
                                    ...
                                    <input type="hidden" name="post_id" value="{{$row['post_id']}}" id="">
                                    <input type="hidden" name="total" value="{{$row['price']}}" id="">
