								...
								<td><div class="col-lg-4">
										...
										<div class="card card-custom">
											<div class="card-header card-header-right">
												...
												<h3 class="up-ban " rowspan="2"><img src="{{asset('images/ribon.png')}}" height="80px" width="80px">
                                            
                                                <!-- <th class="up-ban" rowspan="2"><img src="{{asset('images/ribon.png')}}" height="80px" width="80px" alt=""></th>
                                            -->
											</div>
